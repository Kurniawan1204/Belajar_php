...
<html lang="en">
	...
	<body class="main-body app sidebar-mini ltr bg-purple">
	   ...
	   <div class="page custom-index">
							...
							<div class="main-header-right">
								...
								<div class="nav nav-item  navbar-nav-right mg-lg-s-auto">
									...
									<div class="dropdown main-profile-menu nav nav-item nav-link">
										...
										<a class="profile-user d-flex" href=""><img src="FOTO MUKA.jpg" alt="user-img" class="rounded-circle mCS_img_loaded"><span></span></a>

										<div class="dropdown-menu">
											<div class="main-header-profile header-img">
												<div class="main-img-user"><img alt="" src="FOTO MUKA.jpg"></div>
					...
					<div class="main-sidemenu">
						<div class="main-sidebar-loggedin">
							<div class="app-sidebar__user">
								<div class="dropdown user-pro-body text-center">
									<div class="user-pic">
										<img src="FOTO MUKA.jpg" alt="user-img" class="rounded-50 mCS_img_loaded h-50 w-50 bd-purple">
									</div>
									<div class="user-info">
										<h6 class=" mb-0 text-dark">KURNIAWAN</h6>
										<span class=" app-sidebar__user-name text-sm text-muted">SOFWARE ANGENEERING</span>
									</div>
								</div>
							</div>
						</div>
						<div class="sidebar-navs">
							<ul class="nav  nav-pills-circle">
								<li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="top" title="facebook" data-bs-original-title="Facebook" aria-describedby="tooltip365540">
									<a class="nav-link text-center m-2 bg-white" href="https://www.facebook.com/kurniawan.soleh.56?mibextid=ZbWKwL">
                  					<i class="fab fa-facebook-f"></i>
								  </a>
								</li>
								<li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="top" title="github" data-bs-original-title="github" aria-describedby="tooltip143427">
									<a class="nav-link text-center m-2 bg-white" href="#">
								...
								<li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Logout">
									<a class="nav-link text-center m-2 bg-white">
						...
						<div class="slide-left disabled" id="slide-left"><svg xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width="24" height="24" viewBox="0 0 24 24"><path d="M13.293 6.293 7.586 12l5.707 5.707 1.414-1.414L10.414 12l4.293-4.293z"/></svg></div>
							...
							<li class="slide ">
								<a class="side-menu__item" data-bs-toggle="slide"   href="javascript:void(0);"><i class="side-menu__icon fe fe-list"></i><span class="side-menu__label">FORM</span><i class="angle fe fe-chevron-down"></i></a>
								<ul class="slide-menu">
									<li class="side-menu__label1"><a href="javascript:void(0);">FORM</a></li>
									<li><a class="slide-item" href="form-Handling.php">Form Handling</a></li>
									<li><a class="slide-item" href="form-requid.php">Form Requid</a></li>
			...
			<!-- main-body -->
		<div class="main-body app-content">
...
<div class="main-container container-fluid">
	...
	<div class="breadcrumb-header justify-content-center">
		<div>
			<h4 class="content-title mb-2 p-3 text-info">Hi, welcome the form php</h4>
...
?>
<div class="card bd-primary bd-5 bg-dark bg-opacity-50  mx-auto p-2 justify-content-center" style="max-width: 45rem;"> 
  <div class="card-body p-3 bg-white "> 
    <div class="main-content-label"> PHP Form Requid</div><br>
	<div class="card-title error">* required field</div>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="bg-black-3 text-black p-3 " >  
    <div class="form-group">
<!--Text Fields  -->
  <label>Name:</label> <input type="text" name="name" value="Kurniawan">
  <span class="error">* <?php echo $nameErr;?></span>
</div>
    <div class="form-group">
  E-mail: <input type="text" name="email" value="kkkk@gmail.com">
  ...
  <span class="error"><?php echo $sekolahErr;?></span>
   ...
   Alamat   <div class="form-group">
   <textarea name="alamat" rows="5" cols="40"></textarea>
  
  </div>
  <!-- RADIO BUTTONS -->
  Gender:
  <ul><input type="radio" name="gender" value="female"> Female</ul>
  <ul><input type="radio" name="gender" value="male"> Male</ul>
  <ul><input type="radio" name="gender" value="other"> Other</ul>
